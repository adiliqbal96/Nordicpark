        ...
        <aside class="contact-info">
          ...
          <div class="info-cards">
            ...
            <div class="info-item reveal" style="transition-delay: 0.2s">
              ...
              <div class="info-text">
                <label>{{ i18n.locale === 'da' ? 'Telefon' : 'Phone' }}</label>
            ...
            <div class="info-item reveal" style="transition-delay: 0.3s">
              ...
              <div class="info-text">
                <label>{{ i18n.locale === 'da' ? 'Åbningstider' : 'Opening Hours' }}</label>
                <span>{{ i18n.locale === 'da' ? 'Man-Fre: 09:00 - 16:00' : 'Mon-Fri: 09:00 AM - 04:00 PM' }}</span>
              </div>
            </div>
          </div>
        </aside>
