    ...
    da: {
        ...
        portal: {
            ...
            payment: {
                ...
                alert: 'Vi arbejder på direkte betaling (Stripe/MobilePay). Indtil da skal betaling ske via bankoverførsel med afgiftens nummer som reference.',
    ...
    en: {
        ...
        portal: {
            ...
            payment: {
                ...
                alert: 'We are integrating direct payment (Stripe/MobilePay). Until then, please use bank transfer with the ticket number as reference.',
